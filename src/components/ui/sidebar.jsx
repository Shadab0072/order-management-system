...
const sidebarMenuButtonVariants = ({ variant, size } = { variant: "default", size: "default" }) =>
  cn(
    sidebarMenuButtonBaseClasses,
    sidebarMenuButtonVariantClasses[variant] ?? sidebarMenuButtonVariantClasses.default,
    sidebarMenuButtonSizeClasses[size] ?? sidebarMenuButtonSizeClasses.default
  );
